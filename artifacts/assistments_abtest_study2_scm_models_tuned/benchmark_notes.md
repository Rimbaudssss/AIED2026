...
This run uses ASSISTments OSF Study2 11 A/B Tests as the real-intervention benchmark.
...
- Dataset: ASSISTments OSF Study2 11 A/B Tests.
- Analyzable binary RCT tasks: 11.
- Processed experiments represented: 11.
- Seeds: 42,43,44.
- Mean biased-sample retention: 0.554.

## Current Ranking

- Best ATE abs err: scm_causal (0.0427).
- Best policy value abs err: scm_causal (0.0319).
- Best policy regret: rcgan (0.0076).
